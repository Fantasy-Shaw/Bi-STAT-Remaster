...
def loadData(args):
    data_path = 'STSGCN_data/' + args.dataset + '/' + args.dataset + '.npz'
    SE_FILE = 'lib/SE(' + args.dataset + ').txt'
    # data_path = 'STSGCN_data/PEMS03/PEMS03.npz'
    # SE_FILE = 'STSGCN_data/PEMS03/PEMS03.txt'
