...
if __name__ == "__main__":
    ...
    with mlflow.start_run():
        ...
        bi_stat = model.BISTAT(args.K, args.d, SE.shape[1], TEmbsize, args.P, args.F, args.H, num_sensor, args.L,
                               args.epsilon,
                               hidden_size, args.max_step, args.dhm, device).to(device)
        ...
        mlflow.log_metric("average_rmse", average_rmse)
        mlflow.log_metric("average_mape", average_mape)
        mlflow.pytorch.log_model(torch.load(MODEL_FILE), "model",registered_model_name="BiSTATModel-PEMS04")
